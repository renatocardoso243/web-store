...
export default function EditProduct() {
    ...
    function getProduct() {
        ...
        .catch(error => {
            alert("Não foi possível obter informações do produto")
        })
    }
      ...
      <div className="container my-4">
          <div className="row">
            <div className="col-md-8 mx-auto rounded border p-4">
              <h2 className="text-center mb-5">Editar Produto</h2>
                  ...
                  </div>
              {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-8">
                            <input className="form-control" name="price" defaultValue={initialData.price} type="number" step="0.01" min="1" />
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-8">
                            <textarea className="form-control" name="description" defaultValue={initialData.description} rows="4" />
                    ...
                    <div className="row mb-3">
                        <div className="offset-sm-4 col-sm-8">
                          <img src={"http://localhost:4000/images/" + initialData.imageFilename} width="150" alt="imagem do produto" />
                        </div>
                    </div>
                    ...
                    <div className="row mb-3">
                        <label className="col-sm-4 col-form-label">Data de Criação </label>
                        <div className="col-sm-8">
